...
<head>
    ...
    <title>Register - YouTube Video Suggestion System</title>
...
<body>
    <div class="container">
        ...
        <div class="header">
            ...
            <p class="subtitle">Join YouTube Video Suggestion System</p>
        </div>
...
if(request.getMethod().equalsIgnoreCase("post")){
    ...
    try{
        ...
        PreparedStatement ps=con.prepareStatement("INSERT INTO vdusers VALUES(user_seq.NEXTVAL,?,?,?)");
        ps.setString(1,name);
        ps.setString(2,email);
        ps.setString(3,pass);
        ps.executeUpdate();
        out.println("<div class='message success'>✓ Account created successfully! <a href='login.jsp'>Login here</a></div>");
        con.close();
    }catch(Exception e){
        out.println("<div class='message error'>✗ Registration failed: "+e.getMessage()+"</div>");
    }
}
%>
    </div>
